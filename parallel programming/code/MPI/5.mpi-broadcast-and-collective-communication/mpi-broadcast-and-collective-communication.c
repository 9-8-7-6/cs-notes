...
// Run the command by 
// mpicxx -std=c++11 mpi-broadcast-and-collective-communication.c -o mpi-broadcast-and-collective-communication
// mpirun -np 4 ./mpi-broadcast-and-collective-communication 1000 10
